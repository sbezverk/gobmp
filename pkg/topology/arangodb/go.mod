...
require (
	...
	github.com/sbezverk/gobmp/pkg/message v0.0.0-20200507012955-3207954567bb
	...
	github.com/sbezverk/gobmp/pkg/topology/database v0.0.0-20200507012955-3207954567bb
